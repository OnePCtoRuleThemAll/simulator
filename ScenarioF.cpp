...
void ScenarioF::runReplication(int numberOfReplications, int numberOfTicks)
{
	std::ofstream ofs;
	ofs.open("ScenarioF_Behavior" + std::to_string(this->mBehaviorType) + ".csv", std::ofstream::out | std::ofstream::app);
